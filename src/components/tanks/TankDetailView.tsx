            ...
            if (res.status === "fulfilled") {
              ...
              if (analysis.status === "fulfilled") {
                setBatchGrowthAnalysis((prev) => ({
                  ...prev,
                  [batchId]: analysis.value.data ?? analysis.value,
                }));
              }
    ...
    return feedingRecords
      ...
      .map((r) => {
        ...
        return {
          ...
          recommended,
          foodName:
            r.foodType?.name || r.foodType || r.foodTypeName || "Standard Feed",
        ...
        {/* {isActionRequired && (
          <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4 mb-6 flex items-center justify-between shadow-sm animate-pulse">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-red-900 font-bold uppercase text-xs tracking-widest">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-red-800">
                Failed to load tank history: {detailsError}
              </p>
            </div>
            <Button size="sm" variant="outline" onClick={fetchTankDetails}>
              Retry
            </Button>
          </div>
        )}
