              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white p-3 rounded-lg border">
                    ...
                    <p className="text-xs text-gray-500 mt-1">{totalRequired > 0 ? `${Math.max(0, (currentTank.feeding?.totalMeals || 4) - (currentTank.feeding?.todayMeals || 0))} meals left` : 'No feeding plan'}</p>
                  </div>
                  <div className="bg-white p-3 rounded-lg border">
                    <p className="text-xs text-gray-600 mb-1">Feed Types Used</p>
                ...
                <div className="mt-4 bg-white p-3 rounded-lg border">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium">Overall Feeding Progress</span>
                    <span className="text-sm text-gray-600">{currentTank.feeding?.todayMeals || 0}/{currentTank.feeding?.totalMeals || 4} meals completed</span>
                  </div>
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  ...
                  <div className="bg-[#E0F4F5] p-3 rounded-lg">
                    ...
                    <p className="text-lg font-semibold">{batchGrowthAnalysis[batch.id]?.sgr?.value?.toFixed(2) ? `${batchGrowthAnalysis[batch.id].sgr.value}%/day` : (batch.sgr || '2.1%/day')}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  ...
                  <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                    ...
                    <p className="text-lg font-semibold">{batchGrowthAnalysis[batch.id]?.fcr?.value?.toFixed(2) || batch.fcr || '1.52'}</p>
                  </div>
                  <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200">
